        ...
        <DialogContent data-calculator-dialog="true" className="max-w-none w-screen h-screen m-0 rounded-none bg-background border-none p-0 flex flex-col overflow-hidden">
          ...
          <TooltipProvider>
            <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin">
              <section className="bg-muted/30 p-6 rounded-2xl border border-border/50 shadow-inner animate-entrance-stagger">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                <div className="lg:col-span-5 p-6 rounded-2xl border border-primary/20 bg-primary/5 space-y-4 flex flex-col animate-entrance-stagger" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="lg:col-span-4 p-6 rounded-2xl border border-accent/20 bg-accent/5 space-y-4 flex flex-col animate-entrance-stagger" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="lg:col-span-3 animate-entrance-stagger" style={{ animationDelay: '0.6s' }}>
              ...
              <Accordion type="single" collapsible className="w-full animate-entrance-stagger" style={{ animationDelay: '0.8s' }}>
